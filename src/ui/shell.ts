      ...
      <main class="main">
        ...
        <section class="page" data-page="commands">
          ...
          <div class="command-item"><div class="command-col-command"><code>/t n 100</code></div><div class="command-col-original"><code>/threads n 100</code></div><div class="command-col-desc">列出最近 100 条本地 Codex 会话，最多 200 条。</div></div>
              ...
              <div class="command-item"><div class="command-col-command"><code>/t attach &lt;序号|bridge session id|thread id|名称&gt;</code></div><div class="command-col-original"><code>/t attach &lt;序号|bridge session id|thread id|名称&gt;</code></div><div class="command-col-desc">把 Codex thread 或 Bridge 会话绑定到当前聊天，不一定切换当前线程。</div></div>
              <div class="command-item"><div class="command-col-command"><code>/t archive [序号|bridge session id|thread id|名称]</code></div><div class="command-col-original"><code>/t archive [序号|bridge session id|thread id|名称]</code></div><div class="command-col-desc">归档当前或指定本地 Codex/Bridge 会话，并解除相关绑定。</div></div>
              <div class="command-item"><div class="command-col-command"><code>/t use &lt;序号|bridge session id|thread id|binding id|名称&gt;</code></div><div class="command-col-original"><code>/t use &lt;序号|bridge session id|thread id|binding id|名称&gt;</code></div><div class="command-col-desc">切换当前聊天的激活线程；序号按 <code>/t ls</code> 的绑定顺序。</div></div>
              <div class="command-item"><div class="command-col-command"><code>/t detach &lt;序号|bridge session id|thread id|binding id|名称&gt;</code></div><div class="command-col-original"><code>/t detach &lt;序号|bridge session id|thread id|binding id|名称&gt;</code></div><div class="command-col-desc">解绑当前聊天的指定绑定线程；同名时需改用序号或 ID。</div></div>
              ...
              <div class="command-item"><div class="command-col-command"><code>/t 序号范围</code></div><div class="command-col-original"><code>/t</code> / <code>/t ls</code></div><div class="command-col-desc"><code>/t</code>、<code>/t attach</code> 和 <code>/t archive</code> 使用全局本地 Codex/Bridge 会话列表序号；<code>/t use</code> 和 <code>/t detach</code> 使用 <code>/t ls</code> 当前聊天局部绑定列表序号。</div></div>
